...
if [ -d ${zimbra_java_home} ]; then
  SOLR_JAVA_HOME=${zimbra_java_home}
fi
...
SOLR_HOST=${zimbra_server_hostname}
...
SOLR_PID_DIR==${zimbra_log_directory}
...
SOLR_LOGS_DIR=${zimbra_log_directory}

# Sets the port Solr binds to, default is 8983
SOLR_PORT=`/opt/zimbra/bin/zmprov -l gs ${zimbra_server_hostname} zimbraSolrBindPort | grep zimbraSolrBindPort: | awk '{print $2}'`
